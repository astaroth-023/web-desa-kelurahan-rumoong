            ...
            <section className='relative bg-gray-700 h-[800px]'>
                ...
                <div className='xl:block hidden'>
                    ...
                    <div className='absolute translate-x-1/2 -translate-y-1/2 bottom-10 left-[33%] text-white z-10'>
                        <h1 className='text-xl line-clamp-3 font-semibold w-[800px]'>Selamat datang di Website Kelurahan Rumoong Bawah Kecamatan Amurang Barat Kabupaten Minahasa Selatan Provinsi Sulawesi Utara Tahun 2025</h1>
                    </div>
                </div>
